...
export const MOCK_PERMISSIONS: RolePermissions[] = [
  {
    ...
    views: ['dashboard', 'tables', 'pending_orders', 'orders', 'kitchen', 'bar', 'inventory', 'reports', 'history', 'staff_mgmt', 'menu_mgmt', 'schedule', 'reservations', 'printer_mgmt', 'safety', 'settings', 'service_mgmt'],
  ...
  },
  {
    ...
    views: ['dashboard', 'reports', 'history', 'staff_mgmt', 'schedule', 'safety'],
  ...
  },
  {
    ...
    views: ['dashboard', 'tables', 'pending_orders', 'orders', 'bar', 'history', 'staff_mgmt', 'reports', 'reservations', 'printer_mgmt', 'safety'],
  ...
  },
  {
    ...
    views: ['dashboard', 'kitchen', 'pending_orders', 'inventory', 'menu_mgmt', 'safety', 'staff_mgmt', 'schedule'],
  ...
  },
  {
    role: 'sub_manager',
    label: 'Sub-Gerente',
    views: ['dashboard', 'tables', 'pending_orders', 'orders', 'kitchen', 'bar', 'inventory', 'history'],
  ...
  },
  {
    role: 'waiter',
    label: 'Garçom',
    views: ['tables', 'pending_orders', 'orders', 'bar', 'history'],
