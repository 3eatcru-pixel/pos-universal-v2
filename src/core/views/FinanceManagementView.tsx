...
export const FinanceManagementView: React.FC<FinanceManagementViewProps> = ({ module }) => {
  ...
  const handleAddTransaction = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const newTransaction: Transaction = {
      ...
      paymentMethod: 'other', // Manual entry
          ...
          <div className="fixed inset-0 z-[700] flex items-center justify-center p-6 bg-slate-950/90 backdrop-blur-xl">
             ...
             >
                ...
                <form onSubmit={handleAddTransaction} className="space-y-10">
                   ...
                   <div className="space-y-8">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                         <div className="space-y-3">
                            ...
                            <input name="category" required className="w-full bg-slate-50 border-2 border-transparent rounded-2xl p-5 font-bold italic focus:border-blue-500 outline-none transition-all" placeholder="Ex: Fornecedores, Salários..." />
                         </div>
                         <div className="space-y-3">
                   ...
                   <button type="submit" className="w-full py-6 bg-slate-900 text-white rounded-[1.5rem] font-black uppercase text-[11px] tracking-widest hover:bg-black transition-all shadow-2xl active:scale-[0.98]">Confirmar Transação</button>
                </form>
             </motion.div>
          </div>
        )}
